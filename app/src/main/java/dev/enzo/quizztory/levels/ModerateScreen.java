...
import dev.enzo.quizztory.MQuestionnaires;
import dev.enzo.quizztory.R;

public class ModerateScreen extends AppCompatActivity implements View.OnClickListener {

    TextView noOfQuestions, tvQuestions;
    Button btnOptionA,btnOptionB,btnOptionC,btnOptionD,btnSubmit;

    int score = 0;
    int totalQuestions = MQuestionnaires.questions.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moderate_screen);
    ...
    public void onClick(View v) {
        ...
        if(clikedButton.getId() == R.id.btnSubmit){
            ...
            if(selectedAnswer.equals(MQuestionnaires.answers[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        tvQuestions.setText(MQuestionnaires.questions[currentQuestionIndex]);
        btnOptionA.setText(MQuestionnaires.choices[currentQuestionIndex][0]);
        btnOptionB.setText(MQuestionnaires.choices[currentQuestionIndex][1]);
        btnOptionC.setText(MQuestionnaires.choices[currentQuestionIndex][2]);
        btnOptionD.setText(MQuestionnaires.choices[currentQuestionIndex][3]);
    }
