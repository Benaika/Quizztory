...
import dev.enzo.quizztory.EQuestionnaires;
import dev.enzo.quizztory.R;

public class EasyScreen extends AppCompatActivity implements View.OnClickListener {

    TextView noOfQuestions, tvQuestions;
    Button btnOptionA,btnOptionB,btnOptionC,btnOptionD,btnSubmit;
    int score = 0;
    int totalQuestions = EQuestionnaires.questions.length;
    ...
    public void onClick(View v) {
        ...
        if(clikedButton.getId() == R.id.btnSubmit){
            ...
            if(selectedAnswer.equals(EQuestionnaires.answers[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        tvQuestions.setText(EQuestionnaires.questions[currentQuestionIndex]);
        btnOptionA.setText(EQuestionnaires.choices[currentQuestionIndex][0]);
        btnOptionB.setText(EQuestionnaires.choices[currentQuestionIndex][1]);
        btnOptionC.setText(EQuestionnaires.choices[currentQuestionIndex][2]);
        btnOptionD.setText(EQuestionnaires.choices[currentQuestionIndex][3]);
    }
    void finishQuiz(){
